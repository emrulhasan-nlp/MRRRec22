...
#parser.add_argument("-d", "--dataset", type = str, default = "trip30k", help = "Dataset (Default: traipadvisor)")
...
#parser.add_argument("-d", "--dataset", type = str, default = "tripSummary40k", help = "Dataset (Default: tripsummary)")
...
parser.add_argument("-emb_dim", "--emb_dim", type = int, default = 300, help = "Embeddings Dimension (Default: 200)")
...
#input_embeddings="../glove.6B/glove.6B.300d.txt"
# ============================================================================= INPUT =============================================================================
...
# glove2vec={}
# with open(input_embeddings, encoding='utf8') as f:
# 	for line in f:
# 		word, *vector=line.split()
# 		glove2vec[word]=vector
# for word in vocab:
# 	try:
# 		embeddings[word]=glove2vec[word]
# 	except:
# 		pass
...
w2v_vocab =w2v_model.index_to_key
